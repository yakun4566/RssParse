...
class JanDan:
    ...
    def __init__(self):
        ...
        self.ooxx_rss='https://rsshub.app/jandan/ooxx'
        self.top_ooxx_rss='https://rsshub.app/jandan/top-ooxx'
        self.last_comment = "last_comment"

    def parse_ooxx(self):

        self.logger.info("开始解析 rss:" + self.ooxx_rss)
        rss = feedparser.parse(self.ooxx_rss)
